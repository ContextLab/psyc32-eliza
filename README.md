...
This is a template repository for **PSYC 32 Assignment 2: ELIZA**.  All of the assignment instruction are in the Jupyter (.ipynb) notebook.  To begin, open (click) the `eliza.ipynb` notebook and then click on the blue "Open in Colab" button at the top.  A new tab or window should open in your browser, displaying the notebook in Google Colaboratory.
